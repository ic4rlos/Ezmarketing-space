...
import sty from "./PlasmicAlert.module.css"; // plasmic-import: YI7YyNRx5qnD/css
...
function PlasmicAlert__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox___9M5GH, {
          [sty.freeBoxnoBody___9M5GHlFvR]: hasVariant(
            $state,
            "noBody",
            "noBody"
          ),
          [sty.freeBoxnoHeader___9M5GHwEt4W]: hasVariant(
            $state,
            "noHeader",
            "noHeader"
          ),
          [sty.freeBoxnoIcon___9M5GHRmUd]: hasVariant(
            $state,
            "noIcon",
            "noIcon"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__mb0Zt, {
            [sty.freeBoxnoIcon__mb0ZtRmUd]: hasVariant(
              $state,
              "noIcon",
              "noIcon"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon12Icon
                className={classNames(projectcss.all, sty.svg__dkWsC)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__rdMuV, {
            [sty.freeBoxnoHeader__rdMuVwEt4W]: hasVariant(
              $state,
              "noHeader",
              "noHeader"
            ),
            [sty.freeBoxnoIcon__rdMuVRmUd]: hasVariant(
              $state,
              "noIcon",
              "noIcon"
            )
        ...
        >
          ...
          <div
            className={classNames(projectcss.all, sty.freeBox__hsZxa, {
              [sty.freeBoxnoBody__hsZxalFvR]: hasVariant(
                $state,
                "noBody",
                "noBody"
              ),
              [sty.freeBoxnoHeader__hsZxaWEt4W]: hasVariant(
                $state,
                "noHeader",
                "noHeader"
              )
