...
import sty from "./PlasmicButton6.module.css"; // plasmic-import: fwHm0FuLUMlw/css
...
function PlasmicButton6__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__vEyN, {
          [sty.freeBoxcolor_neutral__vEyNSAvW6]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__vEyNE9B12HGn6]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxcolor_white__vEyNRjhKm]: hasVariant(
            $state,
            "color",
            "white"
          ),
          [sty.freeBoxroundedFull__vEyNAKme0]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__vEyNYJqRt]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__vEyNR3Axy]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__vEyNVA85Z]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__vEyNVHg5W]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__vEyNHGn6]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__xcfas, {
            [sty.freeBoxcolor_neutral__xcfassAvW6]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxiconStart__xcfasKch1L]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__xcfasYJqRt]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__xcfasvA85Z]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__xcfasvHg5W]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__xcfashGn6]: hasVariant(
              $state,
              "type",
              "bordered"
            ),
            [sty.freeBoxtype_soft_color_neutral__xcfasEcNmgSAvW6]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__fpo4Z)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__xVxpA, {
            [sty.freeBoxiconEnd__xVxpARfpNo]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__xVxpAyJqRt]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__xVxpAvA85Z]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__xVxpAvHg5W]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__jnQr1)}
                role={"img"}
              />
            ),
