                              ...
                              customFunction: async () => {
                                return (async () => {
                                  return (async function () {
                                    ...
                                    const client = path.startsWith("/a-")
                                      ? window.supabaseAgency
                                      : window.supabaseCompany;
                                    ...
                                    if (!supabase || !supabase.auth) {
                                      alert(
                                        "Erro: supabase client não carregado. Tente recarregar a página."
                                      );
                                      return;
                                    }
                                    ...
                                    window.location.href = "/find-a-business";
                                  })();
                                })();
                              }
                            };
