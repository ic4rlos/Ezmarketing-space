...
import sty from "./PlasmicLCNewPassword.module.css"; // plasmic-import: MVeoV_338dOO/css
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicLCNewPassword.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicLCNewPassword.pageMetadata.title}
        />
        <meta
          key="twitter:title"
              ...
              return (
                ...
                >
                  <FormItemWrapper
                    className={classNames(
                      "__wab_instance",
                      sty.formField__zt2Zs
                    )}
                    label={
                      <LockSvgIcon
                        className={classNames(projectcss.all, sty.svg__e3L5T)}
                        role={"img"}
                      />
                    }
                    name={"password"}
                  ...
                  <FormItemWrapper
                    className={classNames(
                      "__wab_instance",
                      sty.formField__xmwqz
                    )}
                    label={
                      <LockSvgIcon
                        className={classNames(projectcss.all, sty.svg__qdpIm)}
                        role={"img"}
                      />
                    }
