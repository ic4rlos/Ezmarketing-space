...
import sty from "./PlasmicLinkPreview.module.css"; // plasmic-import: TLlwK-o1sbDA/css
...
function PlasmicLinkPreview__RenderFunc(props: {
  ...
  return (
    ...
    >
      <DataCtxReader__>
        {$ctx => (
          <div className={classNames(projectcss.all, sty.freeBox___25GyL)}>
            <PlasmicImg__
            ...
            <div className={classNames(projectcss.all, sty.freeBox___18BCu)}>
              <div className={classNames(projectcss.all, sty.freeBox___3BjhF)}>
                <h5
