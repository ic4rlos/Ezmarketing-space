...
import sty from "./PlasmicListingListBox.module.css"; // plasmic-import: TCc9OExIxYBX/css
...
function PlasmicListingListBox__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___0GKzX)}>
        {renderPlasmicSlot({
          defaultContents: (
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img__mmaNm)}
              displayHeight={"250px"}
              ...
              loading={"lazy"}
              src={{
                src: "/plasmic/ez_marketing_platform/images/house13533891280Jpg.jpg",
                fullWidth: 1280,
                fullHeight: 853,
      ...
      <div className={classNames(projectcss.all, sty.freeBox__t7B2T)}>
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <div
              ...
              <div className={classNames(projectcss.all, sty.freeBox__vcMtp)}>
                <div className={classNames(projectcss.all, sty.freeBox__pqp5O)}>
                  <_14655891761535698998SvgIcon
                    className={classNames(projectcss.all, sty.svg___4VOsf)}
                    role={"img"}
                  />
                </div>
                <div className={classNames(projectcss.all, sty.freeBox___6N1Z)}>
                  <div
                    className={classNames(
                      projectcss.all,
                      projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__rdIge)}>
                <div
                  className={classNames(
                    projectcss.all,
                    projectcss.__wab_text,
