...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: uMXTXUzmrv_r/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__q2Ysu)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__tq5T)}>
            <div
              className={classNames(
                projectcss.all,
