...
import sty from "./PlasmicModal.module.css"; // plasmic-import: Hu0RbpkquL8l/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_rRfN44pnNMO7"]]: true })}
          ...
          >
            ...
            >
              {renderPlasmicSlot({
                defaultContents: (
                  <div
                    className={classNames(projectcss.all, sty.freeBox___5T15L)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
