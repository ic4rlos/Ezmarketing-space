...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: xrfehBkgVgcl/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: mvdD6SpBKJ1z/css
  ...
  return (
    <BaseDialogTrigger
      ...
      dialog={
        ...
        >
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames(projectcss.all, sty.freeBox__ndGwv)}>
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button2
            className={classNames("__wab_instance", sty.button2__qb1ZY)}
            label={"Open Popover"}
          />
        ),
