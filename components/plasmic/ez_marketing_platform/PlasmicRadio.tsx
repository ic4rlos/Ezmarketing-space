...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: yQ4yXUGRSW64/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__esmhj)}>
        <div className={classNames(projectcss.all, sty.freeBox___3XXtR)} />
      </div>
      {renderPlasmicSlot({
