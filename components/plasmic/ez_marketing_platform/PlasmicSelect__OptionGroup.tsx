...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: Phpgb_HvDsMB/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: CUe39Kg-tPKP/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__brKkg)}
              >
                <div
                  className={classNames(
                    projectcss.all,
              ...
              <Select__Option
                className={classNames("__wab_instance", sty.option___0Pare)}
              >
                <div
                  className={classNames(
                    projectcss.all,
