...
import sty from "./PlasmicSlider.module.css"; // plasmic-import: UbdQmpZX6X8a/css
  ...
  return (
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <div className={classNames(projectcss.all, sty.freeBox___9H6HJ)}>
          {$props.showLabel ? (
            <Label2
      ...
      <div className={classNames(projectcss.all, sty.freeBox__hzt0K)}>
        <div
