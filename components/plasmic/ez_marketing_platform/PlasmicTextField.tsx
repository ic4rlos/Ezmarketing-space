...
import Label from "../../Label"; // plasmic-import: QTg00hVEnyp5/component
import TextInput from "../../TextInput"; // plasmic-import: oVMxKDMIMQqJ/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: A0ZWZhyriedB/component
import Description from "../../Description"; // plasmic-import: 3vXVTKVWAg1p/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: I_ZvJgHiOKWu/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__t7YcZ, {
          [sty.freeBoxiconEnd__t7YcZr4Ar2]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__t7YcZxMlf4]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__t7YcZ5CTHu]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__zVxQr, {
            [sty.freeBoxiconStart__zVxQrXMlf4]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__zVxQr5CTHu]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__pvnse)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__ngm0, {
            [sty.freeBoxiconEnd__ngm0R4Ar2]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__ngm0XMlf4]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__lqFco)}
                role={"img"}
              />
            ),
