...
export type MentalHealthSvgrepoComSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function MentalHealthSvgrepoComSvgIcon(
  props: MentalHealthSvgrepoComSvgIconProps
) {
