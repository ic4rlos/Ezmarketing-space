...
export type Study1SvgrepoComSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function Study1SvgrepoComSvgIcon(props: Study1SvgrepoComSvgIconProps) {
...
export default Study1SvgrepoComSvgIcon;
/* prettier-ignore-end */
